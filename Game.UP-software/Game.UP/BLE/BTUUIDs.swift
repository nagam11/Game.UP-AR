...
struct BTUUIDs {
    ...
    static let B7_UUID = CBUUID(string: "ebd771ed-068d-46ea-bf28-80c8f2db9191")
    static let B8_UUID = CBUUID(string: "34990849-3601-45cf-b7cd-cb7f2d36335f")
    ...
    static let B7_LONG_TOUCH_UUID = CBUUID(string: "455bf338-29c2-4a9f-a6ff-5fa0dfd04af9")
